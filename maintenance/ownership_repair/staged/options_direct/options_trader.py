from capacity_research import record_capacity_rejection
...
def buy_option_contract(
    ...
    if estimated_premium > virtual_cash_available:
        record_capacity_rejection(strategy, underlying, signal_date, option_symbol, 'virtual_capital')
        bot_log(
    ...
    if current_total + estimated_premium > MAX_TOTAL_OPTION_PREMIUM:
        record_capacity_rejection(strategy, underlying, signal_date, option_symbol, 'total_premium')
